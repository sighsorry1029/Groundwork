...
internal static class GroundworkToolsDomain
{
    ...
    internal static GroundworkPlugin.HoverHintMode CropHoverHintMode =>
        Farming.CropHoverHint?.Value ?? GroundworkPlugin.HoverHintMode.Detailed;

    internal static GroundworkPlugin.HoverHintMode ForagingHoverHintMode =>
        Farming.ForagingHoverHint?.Value ?? GroundworkPlugin.HoverHintMode.Detailed;

    internal static GroundworkPlugin.HoverHintMode BeehiveHoverHintMode =>
        Farming.BeehiveHoverHint?.Value ?? GroundworkPlugin.HoverHintMode.Detailed;
    ...
    internal static bool BeehivePollinationPreviewEnabled =>
        Farming.BeehivePollinationPreview?.Value == GroundworkPlugin.Toggle.On;
